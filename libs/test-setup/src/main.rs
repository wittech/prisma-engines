...
async fn main() -> Result<(), quaint::error::Error> {
    let full_sql = "INSERT INTO \"public\".\"user\" (\"id\",\"email\",\"deleted\",\"createdAt\") VALUES (\"edbe0722f5bf40d7a2602cbf4ab5d942\", \"Rowena.Wiza@yahoo.com\", \"f\", \"2024-07-18\") RETURNING \"public\".\"user\".\"id\", \"public\".\"user\".\"email\", \"public\".\"user\".\"deleted\", \"public\".\"user\".\"createdAt\"";
    let conn = Quaint::new("postgres://root:root@localhost:3307/demo_ds").await?;
    let ret = conn.raw_cmd(&full_sql).await?;
    println!("ok");
